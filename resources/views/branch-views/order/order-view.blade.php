                        ...
                        <div class="card-body text-capitalize d-flex flex-column gap-4">
                            ...
                            @if($order['order_type'] != 'pos')
                                <div class="">
                                    ...
                                    <select name="order_status" onchange="route_alert('{{route('branch.orders.status',['id'=>$order['id']])}}'+'&order_status='+ this.value,'{{\App\CentralLogics\translate("Change the order status to ") }}'+  this.value.replace(/_/g, ' '))" class="status custom-select">
                                        @if($order['order_type'] != 'dine_in')
